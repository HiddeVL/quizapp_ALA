package com.hiddevanleeuwen.androidfbles;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void make_hello_world(){
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://androidles-126fd-default-rtdb.europe-west1.firebasedatabase.app");
